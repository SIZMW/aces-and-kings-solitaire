...
/**
 * This class is the move for moving from any given pile to any given king
 * foundation.
 *
 * @author Aditya Nivarthi
 */
public class PileToKingFoundationMove extends PileToPileMove {

    MultiDeck deck;
    final String TABLEAU_STR = "tableau";

    /**
     * Constructor for PileToKingFoundationMove class.
     * 
     * @param from
     ...
     * @param to
     *            The king foundation to move to.
     */
    public PileToKingFoundationMove(Pile from, Card cardDragged, Pile to, MultiDeck deck) {
